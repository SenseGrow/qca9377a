...
#define HDD_OCB_MAGIC 0x489a154f
 ...
 #define _nla_parse(a, b, c, d, e) nla_parse(a, b, c, d, e, NULL)
#else
 #define _nla_parse(a, b, c, d, e) nla_parse(a, b, c, d, e)
#endif
					      ...
					      int data_len)
{
	...
	if (_nla_parse(tb, QCA_WLAN_VENDOR_ATTR_OCB_SET_CONFIG_MAX,
			data,
						...
						int data_len)
{
	...
	/* Parse the netlink message */
	if (_nla_parse(tb, QCA_WLAN_VENDOR_ATTR_OCB_SET_UTC_TIME_MAX,
		      data,
					    ...
					    int data_len)
{
	...
	/* Parse the netlink message */
	if (_nla_parse(tb, QCA_WLAN_VENDOR_ATTR_OCB_START_TIMING_ADVERT_MAX,
		      data,
		      data_len,
					   ...
					   int data_len)
{
	...
	/* Parse the netlink message */
	if (_nla_parse(tb, QCA_WLAN_VENDOR_ATTR_OCB_STOP_TIMING_ADVERT_MAX,
		      data,
		      data_len,
					     ...
					     int data_len)
{
	...
	/* Parse the netlink message */
	if (_nla_parse(tb, QCA_WLAN_VENDOR_ATTR_DCC_GET_STATS_MAX,
		      data,
		      data_len,
					       ...
					       int data_len)
{
	...
	/* Parse the netlink message */
	if (_nla_parse(tb, QCA_WLAN_VENDOR_ATTR_DCC_CLEAR_STATS_MAX,
		      data,
		      data_len,
					      ...
					      int data_len)
{
	...
	/* Parse the netlink message */
	if (_nla_parse(tb, QCA_WLAN_VENDOR_ATTR_DCC_UPDATE_NDL_MAX,
		      data,
		      data_len,
